...
window.onload = function () {
    ...
    if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream){document.documentElement.ontouchstart=window.ontouchstart=function(){registerAudioHandler();Iodine.enableAudio();this.ontouchstart=function(event){};}}else{registerAudioHandler();Iodine.enableAudio();}
    //Download the BIOS:
    downloadBIOS();
}
